...
CONTAINER_NAME="postgres-tsdb-ha"
...
cat $DIR/postgres-tsdb-ha-rbac.json | envsubst | ${CCP_CLI?} create --namespace=${CCP_NAMESPACE?} -f -
...
cat $DIR/postgres-tsdb-ha.json | envsubst | ${CCP_CLI?} create --namespace=${CCP_NAMESPACE?} -f -
