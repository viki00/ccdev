...
cat $DIR/postgres-ha-rbac.json | envsubst | ${CCP_CLI?} create --namespace=${CCP_NAMESPACE?} -f -
...
cat $DIR/postgres-ha.json | envsubst | ${CCP_CLI?} create --namespace=${CCP_NAMESPACE?} -f -
